...
if (Sesija::dajKorisnika() != NULL) {
    if ($_SESSION["uloga"] == "Obični korisnik") {
        ...
        $upit2 = "UPDATE korisnik_tip_korisnika SET id_tip = '3' WHERE id_korisnik LIKE '" . $id . "'";
        $bp->updateDB($upit2);
        ...
        $upitDnevnik = "INSERT INTO dnevnik " .
                ...
                " VALUES (default, '" . $id . "' , '" . $kIme . "' , 'Promjena vrste korisnika: Moderator -> Obicni korisnik', '" . $vrijemeS . "')";
