...
<html lang="hr">
    <head>
        ...
        <meta name="naslov" content="Statistika lojalnosti"/>
    ...
    <header>
        <ul>
            ...
            <li style="float: right;"><a id="odjava" href="admin_statistika_lojalnosti.php" class="active">STATISTIKA LOJALNOSTI</a></li>
        </ul>
        <figure id='logo'>
