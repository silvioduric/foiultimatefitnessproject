...
if (Sesija::dajKorisnika() != NULL) {
    if ($_SESSION["uloga"] == "Obični korisnik") {
        ...
        $zabranaUpit = "UPDATE korisnik_program_vjezbanja SET zabrana = '" . '1' . "' WHERE id_korisnik = '" . $id . "' AND id_program_vjezbanja = '" . $program . "' ";
        ...
        $upitDnevnik = "INSERT INTO dnevnik " .
                ...
                " VALUES (default, '" . $id2 . "' , '" . $kIme . "' , 'Korisniku zabranjen pristup programu.', '" . $vrijemeS . "')";
